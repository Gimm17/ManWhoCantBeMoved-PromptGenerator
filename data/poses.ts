...
export const POSES: PoseOption[] = [
  ...
  // ── Duduk — Ngobrol & Nyimak ──
  { group:'Duduk — Ngobrol & Nyimak', value:'ngeliatin-orang-ngobrol', label:'Ngeliatin orang yang lagi ngobrol', prompt:'sitting quietly, eyes tracking back and forth between two people who are actively talking to each other, head turning slightly left and right following the conversation, silent observer of their dialogue, not participating but fully present and watching' },
  { group:'Duduk — Ngobrol & Nyimak', value:'nyimak-obrolan', label:'Nyimak obrolan — mendengarkan', prompt:'sitting still with hands loosely clasped on the table or in lap, leaning slightly forward toward the speaker, listening intently to the ongoing conversation, eyebrows slightly raised in attention, mouth closed, fully focused on what is being said, absorbing every word without responding' },
  { group:'Duduk — Ngobrol & Nyimak', value:'curhat-gestur', label:'Curhat / cerita sendiri — gestur tangan', prompt:'sitting and talking with visible hand gestures — one hand raised slightly making small expressive motions, fingers open and moving while explaining something personal, occasional pauses with hand in the air, body leaned slightly forward, pouring out feelings to whoever is listening, venting and confessing' },
  { group:'Duduk — Ngobrol & Nyimak', value:'ngobrol-spesifik', label:'Ngobrol dengan orang tertentu', prompt:'sitting, body turned toward a SPECIFIC person next to them, maintaining direct eye contact with that one person, talking in a focused personal one-on-one conversation, gesturing gently with one hand while the other rests on the table, engaged and intimate exchange — NOT talking to the whole group, only to this one person' },
  { group:'Duduk — Ngobrol & Nyimak', value:'pandang-yg-curhat', label:'Memandang orang yang lagi curhat', prompt:'sitting, body angled toward the person who is venting/confessing, making steady compassionate eye contact with them, chin slightly tilted, expression soft and understanding, lips slightly parted as if about to say something supportive but choosing to stay silent and let them finish, deeply empathetic gaze' },
  { group:'Duduk — Ngobrol & Nyimak', value:'simak-yg-curhat', label:'Menyimak orang yang lagi curhat', prompt:'sitting very still, both hands wrapped loosely around a drink or resting flat on thighs, leaning body forward slightly toward the person who is pouring out their heart, nodding subtly, brow slightly furrowed with concern, completely silent and giving full undivided attention — the look of someone who truly cares and is absorbing every painful word' },
  { group:'Duduk — Ngobrol & Nyimak', value:'simak-obrolan-grup', label:'Menyimak obrolan grup', prompt:'sitting back slightly in chair, eyes slowly scanning across the different people in the group who are talking, occasionally nodding gently, hands relaxed in lap or around a cup, not actively participating in the conversation but present and attentive, the quiet one in the group who listens more than speaks, absorbing the collective vibe' },
